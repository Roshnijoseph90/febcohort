...
const DateSelector = ({ selectedDate, setSelectedDate, role }) => {
    ...
    <div className="flex flex-col gap-2">
      <div className="relative flex items-stretch justify-between gap-2 rounded-md bg-gradient-to-br from-indigo-800 to-blue-700 p-2 font-semibold text-white">
        ...
        {isEditing ? (
          <div className="w-full" ref={wrapperRef}>
            <DatePicker
              ...
              format="YYYY-MM-DD"
              className="w-full text-center text-xl font-semibold drop-shadow-sm"
              autoFocus
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          >
            <ArrowRightOutlined className="h-6 w-6 text-white" />
          </Button>
          <Button
            title="Go to today"
            ...
            onClick={handleToday}
          >
            <ReloadOutlined className="h-6 w-6 text-white" />
          </Button>
        </div>
      </div>
